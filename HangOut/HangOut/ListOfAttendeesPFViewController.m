//
//  ListOfAttendeesPFViewController.m
//  HangOut
//
...
@interface ListOfAttendeesPFViewController ()

@end

@implementation ListOfAttendeesPFViewController
...
- (void)objectsDidLoad:(NSError *)error {
 ...
 static NSString *CellIdentifier = @"attendee";
 ...
 // Configure the cell
     ...
     NSLog(@"ATTENDEE: %@", [attendee objectId]);
